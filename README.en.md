Read this in [Português (BR)](README.md).

<p align="center">
  <img src="assets/cover-en.jpg" alt="MCP Builders by Pipefy — AI Toolkit Agent Skills" width="100%">
</p>

A program for the people who build processes in Pipefy. You write the skills that teach an AI assistant to build them too.
...
You submit your skill here. This repository is the program. The MCP server, the CLI, and the skill catalog live in the [Pipefy AI Toolkit](https://github.com/pipefy/ai-toolkit). Selected skills are published there, with you credited as co-author of the commit.
...
**Who owns my skill?** Your name appears as credit wherever the skill is published. By submitting, it goes out under [Apache 2.0](LICENSE).
